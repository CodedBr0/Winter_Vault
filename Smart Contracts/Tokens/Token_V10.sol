...
contract WILD is Context, IERC20, Ownable {
    ...
    function withdrawStuckWLDTokens(uint256 amount) external onlyOwnerOrMarketing {
    ...
    function withdrawStuckETH() external onlyOwnerOrMarketing {
        require(address(this).balance > 0, "No ETH balance in contract");
