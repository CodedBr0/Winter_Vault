...
contract HolderBonusPool is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public WeeklyRewardPerMillion;
    ...
    function updateWeeklyRewardPerMillion(uint256 newRewardPerMillion) external onlyOwner {
        WeeklyRewardPerMillion = newRewardPerMillion;
    }
    ...
    function calculateProportionalReward(uint256 balance, uint256 elapsedTime) internal view returns (uint256) {
        ...
        uint256 weeklyReward = (balance / oneMillionHoldToken) * WeeklyRewardPerMillion;
    ...
    function calculateAPY() internal view returns (uint256) {
        return WeeklyRewardPerMillion * 52 / 1e18; // APY based on weekly reward per million
    }
